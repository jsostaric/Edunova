...
CREATE TABLE IF NOT EXISTS `player_character` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `player_adventure` int(11) NOT NULL,
  `name` varchar(50) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `player_adventure` (`player_adventure`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=2 ;
...
INSERT INTO `player_character` (`id`, `player_adventure`, `name`, `race`, `class`, `level`, `background`, `alignment`, `hd`, `hp`, `proficiency_bonus`) VALUES
